...
`tests/fm-pi-primary-types.test.sh` performs strict no-emit TypeScript checking against the Pi declarations the repository's npm install pins, currently package version 0.84.3.
